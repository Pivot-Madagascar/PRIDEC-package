...
This workflow can be launched for multiple approaches at once and returns a `quarto` report of model performance and variable investigation via the `train_model` function. 
...
- applies each model over each element of the list to get evaluation and inv_var
