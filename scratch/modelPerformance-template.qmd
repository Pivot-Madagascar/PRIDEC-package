...
```{r, fig.height= length(counter_data$arima)*3, out.height=length(counter_data$arima)*3}
#| output: true
...
```{r, fig.height= length(counter_data$glm)*3, out.height=length(counter_data$glm)*3}
#| output: true
...
```{r, fig.height=fig_height, out.height=fig_height}
#| output: true
#| 
