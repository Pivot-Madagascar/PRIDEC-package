...
# quarto render modelPerformance-template_fr.qmd -M title:"Validation des Modèles PRIDEC" --output models-output.html  -P results_dir:"/home/mevans/Dropbox/PIVOT/pride-c/packages/PRIDEC-package/scratch/demo_trainModelResults"
...
tabset_timeSeries <- function(model_name, model_color){
    ...
    'p <- plot_oneModel(pred_forecast, model_name = model_name, model_color = model_color)',
    'plot(p)',
    '```',
    ''
  ), envir = environment(), quiet = TRUE)
